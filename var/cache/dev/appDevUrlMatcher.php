        ...
        if (0 === strpos($pathinfo, '/todo')) {
            ...
            if (0 === strpos($pathinfo, '/todo/de')) {
                ...
                if (0 === strpos($pathinfo, '/todo/details') && preg_match('#^/todo/details/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'todo_details')), array (  '_controller' => 'AppBundle\\Controller\\TodoController::show',));
                }

                // todo_delete
                if (0 === strpos($pathinfo, '/todo/delete') && preg_match('#^/todo/delete/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'todo_delete')), array (  '_controller' => 'AppBundle\\Controller\\TodoController::delete',));
                }
